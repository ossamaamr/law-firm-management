...
> **تحديث القسم الرابع:** أضيف `auditOutbox` دائم مع eventKey فريد، حالات processing/failed، attempts وbackoff وdrain idempotent، وربط إنشاء القضية داخل transaction مع outbox. يبقى F-008 PARTIAL لأن بقية mutations الحساسة تحتاج الربط الذري نفسه، ويبقى F-009 وF-010 وبقية بوابات التشغيل مفتوحة، ولا يزال قرار الإطلاق `NOT READY`. النسبة التاريخية 26/28 ليست النسبة الحالية بعد إضافة Findings الجنائية.
